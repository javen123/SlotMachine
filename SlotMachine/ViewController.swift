...
class ViewController: UIViewController {
    ...
    func setupContainerViews () {
        ...
        self.secondContainer = UIView(frame: CGRectMake(self.view.bounds.origin.x + kMarginForView, firstContainer.frame.height, self.view.bounds.width - (kMarginForView * 2.0), self.view.bounds.height * (3.0 * kSixth)))
    ...
    func setupThirdContainer (containerView: UIView) {
        ...
        self.winnerPaidTitelLabel.font = UIFont(name: "AmericanTypwriter", size: 14)
        self.winnerPaidTitelLabel.sizeToFit()
        self.winnerPaidTitelLabel.center = CGPointMake(containerView.frame.width * 5 * kSixth, containerView.frame.height * 2 * kThird)
